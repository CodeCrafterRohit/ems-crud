...
const EditEmployeeModal = ({ onCancel, employeeToEdit }) => {
  ...
  let [employeeDetails, setEmployeeDetails] = useState({ ...employeeToEdit });
  ...
  //! Here we are using useEffect because any employee (prop) changes automatically updates the new user details
  useEffect(() => {
    if (employeeToEdit) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
        ...
        <button
          type="submit"
          className="px-8 py-2 text-sm bg-indigo-600 text-white font-bold rounded-lg hover:bg-indigo-700 shadow-md shadow-indigo-200 transition-all active:scale-95"
        >
